...
/*   ipv6 support   */
/******************************************/
ALTER TABLE config_info_tag ALTER src_ip TYPE varchar(50);

ALTER TABLE his_config_info ALTER src_ip TYPE varchar(50);

ALTER TABLE config_info ALTER src_ip TYPE varchar(50);

ALTER TABLE config_info_beta ALTER src_ip TYPE varchar(50);